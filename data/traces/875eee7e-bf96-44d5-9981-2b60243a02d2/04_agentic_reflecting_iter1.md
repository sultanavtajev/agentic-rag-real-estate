...
- **Tidspunkt:** 2026-03-22T19:03:51.372167+00:00
- **Varighet:** 91.79s
- **Input tokens:** 20090
- **Output tokens:** 4096
...
Gårdsnummer 96, Bruksnummer 615, Seksjonsnummer 10 i 3240 EIDSVOLL
...
[d002_Salgsoppgave | Side [1]]
p 6k 9i o 9 sk - g g 0 b0 a 0 y1 t g e g 3 service.no
i Eidsvoll kommune. Kontroll:
R R e e v v . . A B 2 0 4 2 . . 0 0 2 3 . . 1 1 5 5 E E n n d d r r e e t t h ca ø r y p d o e r t p . å U b tv o id lig e d i t m er o r t e s n y g d + 3 7 ,2 0 m cm opp Revisjon:B
Plusshus ref.: NArokitreskkto nBisykg Pgrossejerkvteirceend Ae:S
I 636423 Tegningsfase: Format: Utskriftsdato:
J 636424 Byggemeldingstegninger A3 17.01.2013
Produktet er Norsk byggservice AS sin eiendom inntil varen er betalt til fulle
...
eiendom. Eiendomsskatten utgjør 1,8 promille
...
Hverdagslogistikken er enkel med flere skoler og barnehager innen korte
...
[d002_Salgsoppgave | Side [1]]
 og naturnær base med effektiv tilgang
...
carporten/garasjen. Det er utstedt ferdigattest på 8 tomannsboliger og enebolig, se
...
[d002_Salgsoppgave | Side [1]]
rne snø rundt ventilatorhatt eller sette
...
◆ Nei, ikke som jeg kjenner til
18. Vet du om det er gjort arbeid på sentralfyr, radiator, ventilasjon, varmepumpe eller andre
...
[d002_Salgsoppgave | Side [1]]
der vann til sluk ved evt lekkasje.
Ventilasjon
...
Det er foretatt hulltaking fra tilstøtende rom mot dusjsone fra
...
[d002_Salgsoppgave | Side [1]]
2 dører og speil innvendig , servantskap med to skuffer, vask og blandebatteri. Det er også
...
Firmanavn: Monter AS,
Beskrivelse av arbeidet: Opplysning om tidligere utførte tiltak (til

---

[d002_Salgsoppgave | Side [1]]
 en pergola i hagen på ca. 9 m², samt bygget en vedbod
...
[tool_use: validate_risks]
{
  "validated_risks": [
    {
      "risk_id": "R001",
      "description": "Uavklarte byggetiltak uten godkjenning: Pergola (~9 m²) og vedbod er oppført uten byggemelding. Selger påtar seg ikke ansvar for å byggemelde eller få godkjent avvikene – dette blir kjøpers ansvar og risiko.",
      "evidence": [
        "Opplysninger fra tidligere eier: de som solgte boligen satt opp en pergola i hagen på ca. 9 m², samt bygget en vedbod under den eksisterende utvendige trappen mot hagen.",
        "Det gjøres informeres om at mindre tiltak over 15 kvm er søknadspliktige. Eiendommen selges slik den fremstår og selger påtar seg ikke ansvar for å eventuelt byggemelde eller få godkjent ovenstående avvik nå i ettertid. Uavhengig av reaksjonsform fra kommunen, blir dette kjøpers ansvar og risiko siden boligen selges slik den fremstår."
      ],
      "source_documents": [
        "d002_Salgsoppgave"
      ],
    ...
    {
      "risk_id": "R002",
      "description": "Fremtidig reguleringsplan og ringvei gjennom sameiet: Det foreligger en detaljregulering (ID 303531800) for utbygging av boliger på gnr. 96/1. En av de mulige vegtrasèene er en ringvei gjennom sameiets eksisterende vei, som ikke er dimensjonert for økt trafikk. Dette kan medføre vesentlig økt trafikk, støy og anleggsarbeid.",
      "evidence": [
        ...
        "En av de to traseene som det kan være aktuelt å bygge er en ringvei med trasé på den eksisterende veien gjennom sameiet. For mer info se https://arealplaner.no/eidsvoll3240/arealplaner/343?term=303531800.",
    ...
    {
      "risk_id": "R003",
      "description": "Elektrisk anlegg ikke kontrollert (el-takst mangler): Tilstandsrapporten har ikke foretatt kontroll av de elektriske installasjonene. Det er sannsynlig at det kan avdekkes avvik fra dagens forskriftskrav. Samsvarserklæring for utvendige lykter montert av tidligere eier er ikke bekreftet.",
      "evidence": [
        "Det er ikke foretatt kontroll av de elektriske installasjonene (el-takst) selv om bygningssakkyndig kan ha knyttet noen kommentarer til elanlegget ut i fra helt enkle vurderingskriterier. Siden elanlegget ikke er kontrollert er det sannsynlig at det siden kan avdekkes avvik fra dagens forskriftskrav.",
        "Er det foretatt kontroll av det lokale el-tilsyn eller utført utvidet el-kontroll i løpet av de siste 5 år? Nei",
        "Tidligere eier har opplyst at det er satt opp utvendige lykter, arbeid utført av Næss Instalasjon AS. Er det manglende samsvarserklæring på arbeider utført etter 01.01.1999? [ikke bekreftet]",
    ...
    {
      "risk_id": "R004",
      "description": "Flere bygningsdeler ikke undersøkt (TG-IU) pga. snø: Drenering, grunnmur/fundament, taktekking, pipe over tak, terrasse/platting og balkong er ikke vurdert. Skjulte feil og mangler kan avdekkes etter overtakelse.",
      "evidence": [
        "Drenering TG-IU settes på bakgrunn av at tomten er snødekt.",
        "Grunnmur og fundament TG-IU settes på bakgrunn av boligen er oppført med støpt plate på mark.",
        "Kontrollen er kun utført fra bakkenivå, samt at tak/tekking er dekket med snø. Det er derfor ikke foretatt kontroll av alle beslag, overganger eller tekking.",
        "Pipe over tak er ikke undersøkt pga snø.",
    ...
    {
      "risk_id": "R005",
      "description": "Bad med TG-2 – løs flis med risiko for vannlekkasje: Det er registrert 'bom' (manglende heft til underlaget) i en flis mellom dusjsone og vask/servant. Flisen kan løsne og medføre fuktskader.",
      "evidence": [
        "Våtrom: Bad TG-2 settes på bakgrunn av stedvis «bom» i flis.",
    ...
    {
      "risk_id": "R006",
      "description": "Kondens/vanninntrengning via ventilatorhatt om vinteren: Selger opplyser om at det ved kalde temperaturer kan oppstå en liten 'vanndam' på komfyrtopp (ca. 5x5 cm) som følge av kondens i ventilasjonskanalen. Feilen er ikke utbedret.",
      "evidence": [
        "Jeg har eid boligen gjennom 2 vintre og opplevd en liten 'vanndam' på komfyrtopp (ca 5 x 5 cm). Ingen følgeskader. I min eietid har jeg tilbragt mye tid i boligen med oppsussing og kun opplevd dette en gang.",
    ...
    {
      "risk_id": "R007",
      "description": "Legalpant og solidaransvar i sameiet: Seksjonseierne er solidarisk ansvarlig for sameiets økonomi. Andre seksjonseiere har lovbestemt panterett (utinglyst pant) i seksjonen for krav mot eieren for inntil 2G. Endringer i felleskostnader, nye låneopptak eller vedlikehold kan øke de løpende kostnadene.",
      "evidence": [
    ...
    {
      "risk_id": "R008",
      "description": "Bindende TV/internett-avtale med 3 års bindingstid følger seksjonen: Kjøper overtar en kollektivavtale med Viken Fiber (kr 609/mnd) med bindingstid til desember 2027. Kjøper kan ikke fritt velge leverandør i bindingstiden.",
      "evidence": [
    ...
    {
      "risk_id": "R009",
      "description": "Hensynssone H110 – nedslagsfelt drikkevann: Eiendommen ligger i hensynssone H110 (nedslagsfelt for Hurdalssjøen). Tiltak som kan påvirke drikkevannskvaliteten er forbudt, og fremtidige bygge- eller anleggstiltak krever konsekvensanalyse. Dette begrenser mulighetene for utbygging og visse tiltak på eiendommen.",
      "evidence": [
    ...
    {
      "risk_id": "R010",
      "description": "Radonmåling ikke utført: Det er ikke gjennomført radonmåling av boligen. Kjøper overtar ansvaret for eventuelle utbedringstiltak fra overtakelsesdagen, inkludert radonreduserende tiltak dersom radon påvises.",
      "evidence": [
        "Det er ikke utført radonmåling og det er heller ikke krav til dette, for mer informasjon vedrørende radon se www.dsa.no. Kjøper overtar fra overtakelsesdagen ansvaret for eventuelle utbedringstiltak."
      ],
      "source_documents": [
        "d002_Salgsoppgave"
      ],
    ...
    {
      "risk_id": "R011",
      "description": "Overbeheftelse og pantefrafall: Dersom eiendommen blir overbeheftet i salgsprosessen (tinglyste heftelser overstiger salgssummen), kan handel ikke gjennomføres uten at kreditorene gir pantefrafall. Risiko for at handel ikke kan gjennomføres.",
      "evidence": [
    ...
    {
      "risk_id": "R012",
      "description": "Sameiet mangler felles bygningsforsikring: Sameiet Bekkedalshøgda har ikke felles bygningsforsikring. Hver seksjonseier må selv sørge for forsikring av egen seksjon, noe som kan medføre risiko ved skader på fellesarealer eller bygningskroppen.",
      "evidence": [
    ...
    {
      "risk_id": "R013",
      "description": "Begrensninger på eierskap og utleie i sameiet: Kun fysiske personer kan kjøpe seksjoner. Ingen kan eie mer enn to seksjoner. Korttidsutleie av hele boligen er begrenset til maks 90 dager per år. Dette begrenser kjøpers disposisjonsrett.",
      "evidence": [
  ...
  "re_retrieval_queries": [
    "samsvarserklæring elektrisk anlegg el-kontroll avvik",
    "drenering grunnmur fundament tilstand fukt kjeller",
    "pipe skorstein tilstand beslag taktekking kontroll",
    "pergola vedbod søknadspliktig byggemelding kommunen reaksjon",
    "radon måling krav bolig eierseksjon",
    "sameiet bygningsforsikring fellesforsikring ansvar skade",
    "reguleringsplan 303531800 ringvei veitrasé konsekvens sameiet",
    "vanninntrengning kondens ventilasjon komfyr utbedring"
  ]
}
...
```json
{
  "id": "msg_018RJ6VmoXafgAndVqfrVGrB",
  "container": null,
  "content": [
    {
      "id": "toolu_01CR8AUdjD1QvFkSFcHReaeZ",
      "caller": {
        "type": "direct"
      },
      "input": {
