...
- **Tidspunkt:** 2026-03-24T19:04:13.465730+00:00
- **Varighet:** 62.18s
- **Input tokens:** 17954
- **Output tokens:** 3271
  ...
  "risks": [
    {
      ...
      "evidence": [
        "Selger har observert skjeggkre i boligen. Skjeggkre er et insekt i samme familie som sølvkre.",
        "Kjenner du til om det er/har vært skjeggkre i boligen? Nei Ja – Ganske sikker på at...",
...
```json
{
  "id": "msg_01HfcZ1htcW8ayHP7yDPkxhj",
  "container": null,
  "content": [
    {
      "id": "toolu_01KdpyiRq16B8zGxh2LY8mzb",
      "caller": {
        "type": "direct"
      },
      "input": {
